...
public class Field extends JPanel implements ActionListener {
    ...
    public Field() {
        ...
        initField();
        score_board = new JDialog();
        score_board.setSize(100,100);
        score_field = new JLabel();
        String score1 = ""+score;
        score_field.setText("Your score:"+score1);
        score_board.add(score_field);
    ...
    private void loadImages() {
        ...
        ImageIcon iid = new ImageIcon("res/ball.png");
        ball = iid.getImage();
